var Game = (function() {
  ...
  Game.prototype.onMouseDown = function(e) {
    ...
    if (intersections.length === 0) return console.log([])
    var geometry = new THREE.SphereGeometry( 1, 4, 4 );
		var material = new THREE.MeshPhongMaterial( { color: 0xffffff, shading: THREE.FlatShading } );
		var mesh = new THREE.Mesh( geometry, material );
		mesh.position.copy(intersections[0])
		this.scene.add(mesh)
		var hitVoxel = this.voxelAtPosition(intersections[0])
    console.log(hitVoxel, intersections[0])
  }
  ...
  Game.prototype.intersectAllMeshes = function(start, direction) {
    ...
    intersections = intersections.map(function(intersection) {
